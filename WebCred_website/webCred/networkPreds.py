...
root = os.getcwd()
articlePath = f"{root}/static/webCred_NLP/Articles.h5"
jobPath = f"{root}/static/webCred_NLP/jobModel.h5"
sentimentPath = f"{root}/static/webCred_NLP/Sentiment.h5"

articleTokenPath = f"{root}/static/webCred_NLP/articlesTokenizer.pkl"
jobTokenPath = f"{root}/static/webCred_NLP/jobTokenizer.pkl"
sentimentTokenPath = f"{root}/static/webCred_NLP/sentimentTokenizer.pkl"
